...
void memory_copy_python(py::array dst, py::array src) {
    ...
    if (dst_buf.size != src_buf.size) {
        throw std::runtime_error("Source and destination arrays must have the same size");
    }
...
PYBIND11_MODULE(core, m) {
    ...
    m.def("memory_copy", &memory_copy_python, 
          "Copy memory from source to destination array",
          py::arg("dst"), py::arg("src"));

    m.def("memory_copy_int8", &typed_memory_copy<int8_t>,
          "Copy int8 arrays", py::arg("dst"), py::arg("src"));
    m.def("memory_copy_int16", &typed_memory_copy<int16_t>,
          "Copy int16 arrays", py::arg("dst"), py::arg("src"));
    m.def("memory_copy_int32", &typed_memory_copy<int32_t>,
          "Copy int32 arrays", py::arg("dst"), py::arg("src"));
    m.def("memory_copy_int64", &typed_memory_copy<int64_t>,
          "Copy int64 arrays", py::arg("dst"), py::arg("src"));
    m.def("memory_copy_float32", &typed_memory_copy<float>,
          "Copy float32 arrays", py::arg("dst"), py::arg("src"));
