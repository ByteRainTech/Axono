...
class LSTM(Module):
    ...
    def __init__(
        ...
        for _ in range(num_layers):
            layer = {
                'forget': Linear(layer_input_size + hidden_size, hidden_size, device=device),
                'input': Linear(layer_input_size + hidden_size, hidden_size, device=device),
                'cell': Linear(layer_input_size + hidden_size, hidden_size, device=device),
                'output': Linear(layer_input_size + hidden_size, hidden_size, device=device)
            }
