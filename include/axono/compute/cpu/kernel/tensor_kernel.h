...
// Tensor 数据填充内核
template<typename T>
AXONO_FORCE_INLINE void TensorFillKernel(T* data, size_t num_elements, T value) {
...
// Tensor 拷贝内核
AXONO_FORCE_INLINE void TensorCopyKernel(void* dst, const void* src, size_t num_bytes) {
