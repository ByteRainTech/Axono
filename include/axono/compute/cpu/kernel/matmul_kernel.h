...
AXONO_FORCE_INLINE Status DispatchMatMul(const Tensor& a, const Tensor& b, Tensor& result) {
    ...
    switch (a.dtype()) {
        case DataType::FLOAT32:
            MatMulOptimizedKernel(a.data<float>(), b.data<float>(), result.data<float>(), m, n, k);
            break;
        case DataType::FLOAT64:
            MatMulOptimizedKernel(a.data<double>(), b.data<double>(), result.data<double>(), m, n, k);
            break;
        case DataType::INT32:
            MatMulOptimizedKernel(a.data<int32_t>(), b.data<int32_t>(), result.data<int32_t>(), m, n, k);
            break;
        default:
