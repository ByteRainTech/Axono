...
def main():
    ...
    class MNISTDataset(axono.data.Dataset):
        ...
        def __getitem__(self, index):
            ...
            return {"inputs": image, "targets": item["label"]}
    ...
    train_loader = axono.data.DataLoader(train_dataset, batch_size=64, shuffle=True)

    test_loader = axono.data.DataLoader(test_dataset, batch_size=64, shuffle=False)
    ...
    trainer.fit(
        ...
        epochs=5,
        callbacks={"on_epoch_end": viz.update},
    )
