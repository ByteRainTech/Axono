...
Tensor::Tensor() 
    : dtype_(DataType::FLOAT32), num_elements_(0) {
}

Tensor::Tensor(DataType dtype) 
    : dtype_(dtype), num_elements_(0) {
}
...
Tensor::Tensor(const Tensor& other)
    : dtype_(other.dtype_), shape_(other.shape_), num_elements_(other.num_elements_) {
    if (other.data_) {
        InitializeStorage();
...
std::string Tensor::ToString() const {
    ...
    switch (dtype_) {
        ...
        case DataType::INT16:   oss << "int16"; break;
        case DataType::INT32:   oss << "int32"; break;
        case DataType::INT64:   oss << "int64"; break;
        case DataType::FLOAT32: oss << "float32"; break;
        case DataType::FLOAT64: oss << "float64"; break;
        case DataType::BOOLEAN: oss << "bool"; break;
