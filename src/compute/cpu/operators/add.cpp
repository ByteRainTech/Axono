...
Status Add(const Context& ctx, const Tensor& a, const Tensor& b, Tensor& result) {
    (void)ctx; // 暂时未使用
...
Status AddScalar(const Context& ctx, const Tensor& a, void* scalar, size_t scalar_size, Tensor& result) {
    (void)ctx; // 暂时未使用
